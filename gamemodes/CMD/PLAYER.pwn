...
CMD:credits(playerid)
{
	...
	strcat(line3, ""LB_E"Server Founder & Developer: "YELLOW_E"lnrdshz & lukman\n");
	strcat(line3, ""LB_E"Support Developer: "YELLOW_E"Anen\n");
	strcat(line3, ""LB_E"CO Founder: "YELLOW_E"Paul Cozta\n");
	strcat(line3, ""LB_E"Server Manager: "YELLOW_E"Ridho R\n");
	strcat(line3, ""LB_E"Support Website: "YELLOW_E"lukman\n");
	format(line2, sizeof(line2), ""LB_E"Server Support: "YELLOW_E"%s & All SA-MP Team\n\n\
	"GREEN_E"Terima kasih telah bergabung dengan kami! Copyright © Lacoste Roleplay 2020.", pData[playerid][pName]);
	format(line1, sizeof(line1), "%s%s", line3, line2);
   	ShowPlayerDialog(playerid, DIALOG_UNUSED, DIALOG_STYLE_MSGBOX, ""ORANGE_E"LC:RP: "WHITE_E"Server Credits", line1, "OK", "");
	return 1;
}
...
CMD:vip(playerid)
{
	...
	strcat(longstr2, "\n\n"dot""PURPLE_E"VIP Player(3) "PINK_E"Rp.100,000/month "RED_E"|| "PINK_E"Features:\n\
	...
	strcat(longstr2, "\n\n"LB_E"Pembayaran Via Gopay atau DANA. "LB2_E"Harga VIP Gold "LB_E"Rp.2,000/gold.\n\
	"YELLOW_E"Untuk informasi selengkapnya hubungi lnrdshz atau lukman!");
	ShowPlayerDialog(playerid, DIALOG_UNUSED, DIALOG_STYLE_MSGBOX, ""ORANGE_E"LC:RP "PINK_E"VIP SYSTEM", longstr2, "Close", "");
	return 1;
}
...
{
    new line3[3500];
    strcat(line3, ""RED_E"...:::... "DOOM_"Donate List Lacoste Roleplay "RED_E"...:::...\n");
    ...
    strcat(line3, ""DOOM_"1. VIP Regular(1 Month) >> "RED_E"800 Gold\n");
    strcat(line3, ""DOOM_"2. VIP Premium(1 Month) >> "RED_E"1300 Gold\n");
    strcat(line3, ""DOOM_"3. VIP Platinum(1 Month) >> "RED_E"1500 Gold\n\n");
    ...
    strcat(line3, ""WHITE_E"1. NAMA : "RED_E"lnrdshz\n");
    strcat(line3, ""WHITE_E"   Discord: "RED_E"Lnrdshz#3203\n");
    strcat(line3, ""WHITE_E"-  WA: "RED_E"082113635244\n\n");

    strcat(line3, ""RED_E"..::.. "WHITE_E"NOTE "RED_E"..::..\n");
    strcat(line3, ""WHITE_E"Note: "RED_E"Pembayaran Via Gopay atau DANA!\n\n");

	ShowPlayerDialog(playerid, DIALOG_UNUSED, DIALOG_STYLE_MSGBOX, ""ORANGE_E"LCRP: "WHITE_E"DONATE LIST", line3, "Okay", "");
	return 1;
}
...
CMD:time(playerid)
{
	...
	format(line2, sizeof(line2), ""WHITE_E"Paycheck Time: "YELLOW_E"%d remaining\n"WHITE_E"Job Delay Time: "RED_E"%d second\n"WHITE_E"Side Job Delay Time: "RED_E"%d second\n"WHITE_E"Plant Time(Farmer): "RED_E"%d second\n"WHITE_E"Arrest Time: "RED_E"%d second\n"WHITE_E"Jail Time: "RED_E"%d second\n", paycheck, pData[playerid][pJobTime], pData[playerid][pSideJobTime], pData[playerid][pPlantTime], pData[playerid][pArrestTime], pData[playerid][pJailTime]);
   	ShowPlayerDialog(playerid, DIALOG_UNUSED, DIALOG_STYLE_MSGBOX, ""ORANGE_E"LCRP: "WHITE_E"My Time", line2, "Okay", "");
	return 1;
}
...
GetGunLicType(playerid)
{
	new gunlic[24];
	switch (pData[playerid][pGunLicType]) {
		case 1: gunlic = "Handgun";
		case 2: gunlic = "Rifle Gun";
		case 3: gunlic = "Automatic Gun";
	}
...
{
	new drivelic[128],flylic[128],gunlic[128],lumberlic[128],trucklic[128],option[32];

	if (pData[playerid][pDriveLic] == 1) format(drivelic, sizeof(drivelic), ""GREEN_E"Passed until %s from now.", ReturnTimelapse(gettime(), pData[playerid][pDriveLicTime]));
	else drivelic = ""RED_E"Not passed.";

	if (pData[playerid][pFlyLic] == 1) format(flylic, sizeof(flylic), ""GREEN_E"Passed until %s from now.", ReturnTimelapse(gettime(), pData[playerid][pFlyLicTime]));
	else flylic = ""RED_E"Not passed.";

	if (pData[playerid][pGunLic] == 1) format(gunlic, sizeof(gunlic), ""GREEN_E"Passed until %s from now. (Type: %s)", ReturnTimelapse(gettime(), pData[playerid][pGunLicTime]),GetGunLicType(playerid));
	else gunlic = ""RED_E"Not passed.";

	if (pData[playerid][pTruckerLic] == 1) format(trucklic, sizeof(trucklic), ""GREEN_E"Passed until %s from now.", ReturnTimelapse(gettime(), pData[playerid][pTruckerLicTime]));
	else trucklic = ""RED_E"Not passed.";

	if (pData[playerid][pLumberLic] == 1) format(lumberlic, sizeof(lumberlic), ""GREEN_E"Passed until %s from now.", ReturnTimelapse(gettime(), pData[playerid][pLumberLicTime]));
	else lumberlic = ""RED_E"Not passed.";


	new value[64];
	if (sscanf(params,"s[32]S()[64]",option,value)) {
		SendClientMessage(playerid, COLOR_LIME, "[======= My Licences =======]");
		SendClientMessageEx(playerid,COLOR_WHITE,"Driving License: %s",drivelic);
		SendClientMessageEx(playerid,COLOR_WHITE,"Flying License: %s",flylic);
		SendClientMessageEx(playerid,COLOR_WHITE,"Firearms License: %s",gunlic);
		if (pData[playerid][pJob] == 3 || pData[playerid][pJob2] == 3) {
			SendClientMessageEx(playerid,COLOR_WHITE,"Lumberjack License: %s",lumberlic);
		}
		if (pData[playerid][pJob] == 4 || pData[playerid][pJob2] == 4) {
			SendClientMessageEx(playerid,COLOR_WHITE,"Trucker License: %s",trucklic);
		}
		SendClientMessageEx(playerid,COLOR_RED,"NOTE: "WHITE_E"/licenses show [playerid/name] to show your licenses to other players.");
		return 1;
	}
	if (!strcmp(option, "show", true)) {
		new otherid;
		if (sscanf(value, "u", otherid)) return Usage(playerid,"/licenses show [playerid/name]");

		SendClientMessageEx(otherid, COLOR_LIME, "[======= %s Licences =======]",pData[playerid][pName]);
		SendClientMessageEx(otherid,COLOR_WHITE,"Driving License: %s",drivelic);
		SendClientMessageEx(otherid,COLOR_WHITE,"Flying License: %s",flylic);
		SendClientMessageEx(otherid,COLOR_WHITE,"Firearms License: %s",gunlic);
		if (pData[playerid][pJob] == 3 || pData[playerid][pJob2] == 3) {
			SendClientMessageEx(otherid,COLOR_WHITE,"Lumberjack License: %s",lumberlic);
		}
		if (pData[playerid][pJob] == 4 || pData[playerid][pJob2] == 4) {
			SendClientMessageEx(otherid,COLOR_WHITE,"Trucker License: %s",trucklic);
		}

		Info(playerid,"You has show your licenses to %s.",ReturnName(otherid));
		Info(playerid,"%s has showing licenses to you.", ReturnName(playerid));
	}
	return 1;
}
...
CMD:newidcard(playerid, params[])
{
	...
	pData[playerid][pIDCardTime] = gettime() + (16 * 86400);
	...
	foreach(new i : PVehicles)
	{
		if(vehid == pvData[i][cVeh])
		{
			if(pvData[i][cOwner] == pData[playerid][pID])
			{
				...
				format(pvData[i][cPlate], 32, "LCRP-%d", rand);
	...
	if(pData[playerid][pVip] > 0)
	{
		if(pData[playerid][pJob] == 0 || pData[playerid][pJob2] == 0)
		{
			if(pData[playerid][pJob] == 0)
			{
				...
				else if (pData[playerid][pJob] == 0 && GetPlayerState(playerid) == 1 && IsPlayerInRangeOfPoint(playerid, 3.0, 154.19, -1946.61, 5.38)) {
					pData[playerid][pGetJob] = 8;
					Info(playerid,"Anda telah berhasil mendaftarkan job Nelayan. /accept job untuk konfirmasi.");
				}
			...
			else if(pData[playerid][pJob2] == 0)
			{
				...
				else if (pData[playerid][pJob2] == 0 && GetPlayerState(playerid) == 1 && IsPlayerInRangeOfPoint(playerid, 3.0, 154.19, -1946.61, 5.38)) {
...
CMD:phone(playerid)
{
	...
	ShowPlayerDialog(playerid,DIALOG_PHONE,DIALOG_STYLE_LIST,"My Phone","Power On/Off\nShow Contacts\nSMS","Select","Cancel");
	return 1;
}
...
{
	if (pData[playerid][pDice] != 1)
		return Error(playerid, "You don't have dice!");

	new rolls;
	if (sscanf(params, "d", rolls))
		return Usage(playerid,"/dice [1 - 4]");

	switch (rolls) {
		case 1: {
			new rand = random(6)+1;
			SendNearbyMessage(playerid, 20.0, COLOR_PURPLE, "* %s rolls a dice that lands on %d",ReturnName(playerid),rand);
		}
		case 2: {
			new rand1 = random(6)+1;
			new rand2 = random(6)+1;
			SendNearbyMessage(playerid, 20.0, COLOR_PURPLE, "* %s rolls a dice that lands on %d-%d",ReturnName(playerid),rand1,rand2);
		}
		case 3: {
			new rand1 = random(6)+1;
			new rand2 = random(6)+1;
			new rand3 = random(6)+1;
			SendNearbyMessage(playerid,20.0,COLOR_PURPLE,"* %s rolls a dice that lands on %d-%d-%d",ReturnName(playerid),rand1,rand2,rand3);
		}
		case 4: {
			new rand1 = random(6)+1;
			new rand2 = random(6)+1;
			new rand3 = random(6)+1;
			new rand4 = random(6)+1;
			SendNearbyMessage(playerid,20.0,COLOR_PURPLE,"* %s rolls a dice that lands on %d-%d-%d-%d",ReturnName(playerid),rand1,rand2,rand3,rand4);
		}
		default: Usage(playerid,"/dice [1 - 4]");
	} 
	return 1;
}
...
CMD:buy(playerid, params[])
{
	...
	// Nelayan
	// if (IsPlayerInRangeOfPoint(playerid, 2.5, 2351.92, -1170.46, 28.06)) {
	// 	if (pData[playerid][pJob] == 8 || pData[playerid][pJob2] == 8) {
	// 		ShowPlayerDialog(playerid, 	DIALOG_TRAWL, 	DIALOG_STYLE_LIST, 	"Buy Trawl", 	"Pack 1: 30 Trawl ($200)\nPack 2: 60 Trawl ($500)", 	"Buy", 	"Cancel");
	// 	} else return Error(playerid,"Kmau bukan seorang nelayan!");
	// }
	//Material
	...
	if(IsPlayerInRangeOfPoint(playerid, 2.5, 315.07, 926.53, 20.46))
	{
		...
		} else return Error(playerid,"You are not Mechanic.");
	}
	// Ammunation
	if (IsPlayerInRangeOfPoint(playerid, 2.5, 314.25, -133.44, 999.60)) {
		if (pData[playerid][pGunLic] == 1 && pData[playerid][pGunLicTime] != 0) {
			new str[256];
			format(str, sizeof(str), "Weapon\tPrice\n");
			format(str, sizeof(str), "%sSilenced Pistol\t%s\n", str, FormatMoney(4000));
			format(str, sizeof(str), "%sDesert Eagle\t%s\n", str, FormatMoney(10000));
			format(str, sizeof(str), "%sRifle\t%s\n", str, FormatMoney(5000));
			format(str, sizeof(str), "%sShotgun\t%s\n", str, FormatMoney(7000));
			format(str, sizeof(str), "%sMP5\t%s\n", str, FormatMoney(15000));
			format(str, sizeof(str), "%sM4\t%s", str, FormatMoney(20000));
			ShowPlayerDialog(playerid, DIALOG_AMMUNATION, DIALOG_STYLE_TABLIST_HEADERS, "Ammunation", str, "Buy", "Cancel");
		} else return Error(playerid,"You must have valid Firearms Licenses.");
	}
	//Food and Seed
