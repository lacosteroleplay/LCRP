...
{
	"~y~Lacoste ~w~Roleplay",
	"~b~~w~lacosteroleplay.com",
	"~w~Lacoste ~y~Roleplay"
};
...
CreatePlayerTextDraws(playerid)
{
	...
	//HBE Textdraw Modern
	DPname[playerid] = CreatePlayerTextDraw(playerid, 537.000000, 367.333251, "Lukman_Aselole");
...
CreateTextDraw()
{
	...
	//Server Name
	SOIRP_TXD = TextDrawCreate(25.777742, 421.119964, "~r~Lacoste ~w~Roleplay");
	...
	TextDrawColor(TDEditor_TD[1], 0x7fffd4ff);
	...
	TextDrawColor(TDEditor_TD[6], 0x7fffd4ff);
