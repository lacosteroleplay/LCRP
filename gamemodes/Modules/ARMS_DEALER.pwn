...
CMD:creategun(playerid, params[])
{
	...
	Silenced Pistol(ammo 70)\t500 & 500 / $6.000\n");
	format(Dstring, sizeof(Dstring), "%sColt45 9MM(ammo 70)\t500 & 500 & $7.000\n", Dstring);
	format(Dstring, sizeof(Dstring), "%sDesert Eagle(ammo 70)\t500 & 500 & $11.000\n", Dstring);
	format(Dstring, sizeof(Dstring), "%sShotgun(ammo 50)\t500 & 500 & $9.000\n", Dstring);
	format(Dstring, sizeof(Dstring), "%sRifle(ammo 35)\t500 & 500 & $10.000\n", Dstring);
	format(Dstring, sizeof(Dstring), "%sAK-47(ammo 100)\t500 & 500 & $17.000\n", Dstring);
