...
CreateServerPoint()
{
	...
	if(IsValidDynamic3DTextLabel(AmmuText))
        DestroyDynamic3DTextLabel(AmmuText);
		
	if(IsValidDynamicPickup(AmmuPickup))
		DestroyDynamicPickup(AmmuPickup);
	...
	ApotekPickup = CreateDynamicPickup(1239, 23, 1449.27,-32.31,1000.92, -1, -1, -1, 5.0);
	format(strings, sizeof(strings), "[Hospital]\n"WHITE_E"Apotek Stock: "LG_E"%d\n"LB_E"/apotek", Apotek);
	ApotekText = CreateDynamic3DTextLabel(strings, COLOR_PINK, 1449.27,-32.31,1000.92, 5.0); // Apotek hospital
	...
	AmmuPickup = CreateDynamicPickup(1239, 23, 314.25, -133.44, 999.60, -1, -1, -1, 5.0);
	format(strings, sizeof(strings), "[Ammunation]\n"WHITE_E"Type '"LG_E"/buy"WHITE_E"' to buy gun.");
	AmmuText = CreateDynamic3DTextLabel(strings, COLOR_LIME, 314.25, -133.44, 999.60, 5.0);
}
